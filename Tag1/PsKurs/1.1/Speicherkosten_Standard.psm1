...
<#
 .Synopsis
 Erzeugen eines Passworts
 .Description
 Passwort mit einer bestimmmten Anzahl an Zeichen erzeugen
 .Example
 Get-Password
 .Example
...
{
    param([ValidateScript({$_ -gt 0})][Int]$Length=8, [Switch]$AlphaOnly)
    if ($AlphaOnly)
    {
        $Range = (48..57),(65..90)
    }
    ...
    ($Range | Get-Random -Count $Length).ForEach{[Char]$_} -join ""
}